...
public class Topo extends JFrame {
	...
	public Topo() {
		...
		btnNewButton.setBounds(81, 10, 93, 23);
		...
		JButton btnNewButton_1 = new JButton("\u62D3\u6251\u6392\u5E8F");
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					textArea.setText(TopologicalSort.topologicalSort(algraph));
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
		...
		btnNewButton_1.setBounds(224, 351, 93, 23);
		...
		btnNewButton_2.setBounds(276, 10, 93, 23);
